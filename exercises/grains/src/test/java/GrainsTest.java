...
public class GrainsTest {
    ...
    public void countAtSquare1() {
        BigInteger result = grains.onSquare(1);
    ...
    public void countAtSquare2() {
        BigInteger result = grains.onSquare(2);
    ...
    public void countAtSquare3() {
        BigInteger result = grains.onSquare(3);
    ...
    public void countAtSquare4() {
        BigInteger result = grains.onSquare(4);
    ...
    public void countAtSquare16() {
        BigInteger result = grains.onSquare(16);
    ...
    public void countAtSquare32() {
        BigInteger result = grains.onSquare(32);
    ...
    public void countAtSquare64() {
        BigInteger result = grains.onSquare(64);
    ...
    public void totalNumberOfGrainsOnABoard() {
        BigInteger total = grains.onBoard();
