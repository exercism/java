...
public class LogLevelsTest {
    @Test
    @Tag("task:1")
    @DisplayName("The message method method returns the log line's message of an error log")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("The message method method returns the log line's message of a warning log")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("The message method method returns the log line's message of an info log")
    ...
    @Test
    @Tag("task:1")
    @DisplayName("The message method method returns the log line's message after removing leading and trailing spaces")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("The logLevel method method returns the log level of an error log line")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("The logLevel method method returns the log level of a warning log line")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("The logLevel method method returns the log level of an info log line")
