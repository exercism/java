...
public class BlackjackTest {
    ...
    @Test
    @Tag("task:1")
    @DisplayName("The parseCard returns the correct numerical value of a given card name")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("The isBlackjack method returns true when two cards make up a blackjack")
    ...
    @Test
    @Tag("task:2")
    @DisplayName("The isBlackjack method returns false when two cards do not make up a blackjack")
    ...
    @Test
    @Tag("task:3")
    @DisplayName("The firstTurn method returns the correct strategy given two cards and dealer card")
