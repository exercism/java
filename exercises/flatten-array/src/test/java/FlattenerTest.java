...
public class FlattenerTest {
    ...
    public void testFiveLevelsOfNestingWithNoNulls() {
        assertEquals(
            ...
            flattener.flatten(asList(0, '2', asList(asList(2, "three"), '8', 100, "four",
    ...
    public void testSixLevelsOfNestingWithNoNulls() {
        assertEquals(
            ...
            flattener.flatten(asList("one", asList('2', singletonList(singletonList(3)),
                              asList('4', singletonList(singletonList(5))), "six", 7), "8")));
    }
    ...
    public void testNestedListsFullOfNullsOnly() {
        assertEquals(
            ...
            flattener.flatten(
              asList(
                null, singletonList(singletonList(singletonList(null))),
