...
public class VariableLengthQuantityTest {
    ...
    public void testManyMultiByteValues() {
        List<String> expected = Arrays.asList("0xc0", "0x0", "0xc8", "0xe8", "0x56", "0xff", "0xff", "0xff", "0x7f", "0x0", "0xff", "0x7f", "0x81", "0x80", "0x0");
    ...
    public void testDecodeMultipleBytes() {
        ...
        List<Long> bytes = Arrays.asList(0xc0L, 0x0L, 0xc8L, 0xe8L, 0x56L, 0xffL, 0xffL, 0xffL, 0x7fL, 0x0L, 0xffL, 0x7fL, 0x81L, 0x80L, 0x0L);
