...
Hi! Thanks ❤️ for contributing to the Exercism Java track!
...
#### 3.1 Check whether the reference implementation passes the tests

```sh
gradle test
```

#### 3.2 Check whether the reference implementation passes the Checkstyle validations

```sh
gradle check
```

#### 3.3 Check whether the starter implementation is able to compile with the tests
...
### 2. Importing the Gradle project
...
<h2 align="center">Thanks for your valuable contribution to the community<h2/> 
